...
const STARTERS = [
  "A client in Low Yellow is scared to expand after a bad flare. What do I do?",
  "A client asks whether to stop tracking their heart rate.",
  "A caregiver says their loved one keeps saying they've gone backwards.",
  "Where do coaches currently disagree about when to stop an activity?",
];
  ...
  return (
    <div className="page-solo">
      <div className="ask">
        {!chat.length && (
          <>
            <h2 className="sec-h">Ask the curriculum</h2>
            <p className="sec-p">
              Ask a coaching question and get an answer grounded in the curriculum, with the entries it
              drew on. Answers come from what the team has written down, so gaps and disagreements show
              up as gaps and disagreements.
            </p>
        ...
        <div className="composer">
          <div className="box">
            <textarea
              ref={boxRef}
              rows={1}
              placeholder="Describe the coaching situation…"
              value={draft}
              onChange={(e) => {
          ...
          <p className="note" style={{ margin: "7px 2px 0" }}>
            Answers are drafted from curriculum entries and can be wrong. Nothing here is a clinical decision.
          </p>
        </div>
      </div>
    </div>
