...
/**
 * Put an earlier version of an entry back in force. Review Board only.
...
export async function POST(req, { params }) {
  ...
  if (!user.isBoard) {
    return NextResponse.json({ error: "Only the Review Board can restore a version." }, { status: 403 });
  }
